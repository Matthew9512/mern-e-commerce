      ...
      >
         <SplideSlide>
            <div className='h-full w-full relative bg-primaryBlack/30'>
               <Image src='sliderImg3.jpg' variant='primary' customClass='w-full h-[815px]' />
               <div className='absolute lg:top-20 lg:right-20 bottom-10 left-10 flex flex-col gap-6 text-primaryWhite'>
                  ...
                  <Button variant='primary' onClick={scrollToProducts} customClass='lg:mx-0 ml-0'>
                     See full offer
                  </Button>
               </div>
            </div>
         ...
         <SplideSlide>
            <div className='h-full w-full relative bg-primaryBlack/30'>
               <Image src='sliderImg2.jpg' variant='primary' customClass='w-full h-[815px]' />
         ...
         <SplideSlide>
            <div className='h-full w-full relative bg-primaryBlack/30'>
               <Image src='sliderImg1.jpg' variant='primary' customClass='w-full h-[815px]' />
